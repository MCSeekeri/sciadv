...
游戏里有一句话：其理论构建于相对论，量子力学和 M 理论之上。
...
**Bug**，**崩溃**，**计算**，**重构**。这其中，**崩溃**是最重要的过程。导致世界崩溃的 bug 可能是 D-Mail，可能是时间机器，也可能是某个决定性物品的改变。没有**崩溃**就没有**计算**，也就没有**重构**。
...
那为什么萌郁离开 0.52% 就能活了，因为她的死只是因为找到了 ibn5100 而被遗弃。因果决定收束。
...
分歧点是什么？首封 D-Mail。
于是把 D-Mail 删了，α没了，变到β了，真由理活了。（这其中也有很多弯弯绕的部分，先略过）
