...
在官方衍生小说{% span blue, "命运石之门 3 境界面上的Steins;Gate: Rebirth" %}中曾有类似的{% nota 描述, "由贴吧 吧友*qq223344qqq* 翻译" %}：
...
根据{% nota Q5, "为什么世界上消失了一个人，世界线变动率却没有发生变化？" %}，世界线并未完全重构，只是经历了小数点六位之后的“{% emp 微小变化 %}”，因此冈部并不是完全意义上的“消失”——即与他有关联的物品、事件都不会消失，只是他个人的存在状态发生了变化。
